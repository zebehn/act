...
def get_args_parser():
    ...
    parser.add_argument('--ckpt_dir', action='store', type=str, default='', help='ckpt_dir')
    parser.add_argument('--policy_class', action='store', type=str, default='ACT', help='policy_class, capitalize')
    parser.add_argument('--task_name', action='store', type=str, default='sim_transfer_cube_scripted', help='task_name')
    parser.add_argument('--seed', action='store', type=int, default=0, help='seed')
    parser.add_argument('--num_epochs', action='store', type=int, default=1, help='num_epochs')
